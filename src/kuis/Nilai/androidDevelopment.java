 ...
 * @author wachid op
 */
public class androidDevelopment implements menghitungNilai{
    ...
    public androidDevelopment(String nik, String nama, double tulis, double coding, double wawancara) {
        this.nik = nik;
        this.nama = nama;
        this.tulis = tulis;
        this.coding = coding;
